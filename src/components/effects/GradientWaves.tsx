...
export type GradientWavesTheme = 'reactbits' | 'nebula' | 'anomaly' | 'cyber' | 'off';

export interface WavesPresetConfig {
  label: string;
  desc: string;
  horizonColor: string;
  waveColor: string;
...
export const WAVES_PRESETS: Record<Exclude<GradientWavesTheme, 'off'>, WavesPresetConfig> = {
  reactbits: {
    label: 'ReactBits (Original)',
    desc: 'Ondas púrpuras y magenta con niebla blanca y paralaje interactivo.',
    horizonColor: '#5227FF',
    waveColor: '#FF9FFC',
    crestColor: '#FFFFFF',
    speed: 0.4,
  ...
  nebula: {
    label: 'Nebulosa Focus',
    desc: 'Tonos cósmicos azul índigo y cian alineados al ecosistema Focus.',
    horizonColor: '#100b2b',
    waveColor: '#6366f1',
    crestColor: '#38bdf8',
    speed: 0.3,
  ...
  anomaly: {
    label: 'Radar Anomalía',
    desc: 'Ondas violetas y fucsia de alta turbulencia para detección de alertas.',
    horizonColor: '#2b0938',
    waveColor: '#c084fc',
    crestColor: '#fb7185',
    speed: 0.45,
  ...
  cyber: {
    label: 'Cyber Deep Blue',
    desc: 'Atmósfera oceánica en azul zafiro y cian luminoso.',
    horizonColor: '#051329',
    waveColor: '#0ea5e9',
    crestColor: '#22d3ee',
    speed: 0.32,
...
const ctxMap = new WeakMap<HTMLElement, ContextValue>();
